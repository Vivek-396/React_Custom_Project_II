...
class SignIn extends React.Component{
    ...
    signIn = (event) => {
      ...
      if(this.username===this.password){
          ...
          for(var i=0;i<len;i++){
              console.log(this.props.users[i].username);
          ...
          if(index!==-1){
              ...
              var objUser = new ObjCreate(index+1,ele.name,ele.username,ele.email,ele.phone,ele.website);
              //console.log(objUser);
    ...
    render(){
        return(
          ...
          <div>
            ...
            <button type="button" className="upperBtn" onClick = {this.handleSignUp} >Log In</button>
            <hr/>
          </div>
